...
{
    public abstract class AzureSqlDatabaseShortTermRetentionPolicyCmdletBase : AzureSqlCmdletBase<IEnumerable<AzureSqlDatabaseShortTermRetentionPolicyModel>, AzureSqlDatabaseBackupAdapter>
    {
        #region parameter set defintions
        /// <summary>
